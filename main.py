...
# 人脸识别模型，提取 128D的特征矢量
facerec = dlib.face_recognition_model_v1("E:/PycharmProjects/FaceRecognition/libfile/dlib_face_recognition_resnet_model_v1.dat")
# 计算两个128D向量间的欧式距离
def return_euclidean_distance(feature_1, feature_2):
    ...
    return dist
# 处理存放所有人脸特征的 csv
path_features_known_csv = "E:/PictureTest/PeopleFaceData/PersonCsv/face_feature_mean.csv"
        ...
        if len(faces) != 0:
            ...
            for k in range(len(faces)):
                ...
                if min(e_distance_list) < 0.4:
                    # 这里可以修改摄像头中标出的人名
                    # 1、遍历文件夹目录
                    folder_name = 'E:/PictureTest/PeopleFaceData/person/'
                    # 最接近的人脸
                    ...
                    for i, d in enumerate(faces):
                        ...
                        # 要存储visitor人脸图像文件的路径
                        path_visitors_save_dir = "E:/PictureTest/PeopleFaceData/visitor/know"
                        # 存储格式：2021-11-24-14-33-40wang.jpg
                    ...
                    for i, d in enumerate(faces):
                        ...
                        path_visitors_save_dir = "E:/PictureTest/PeopleFaceData/visitor/unknow"
                        # 存储格式：2021-11-24-14-33-40unknown.jpg
                        now_time = time.strftime("%Y-%m-%d-%H-%M-%S", time.localtime())
                        # print(save_name)
                        # 本次图片保存的完整url
